      ...
      <div className="w-1/3 max-w-lg  rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <div className="mt-4 flex gap-2">
          <button
            ...
            className={`rounded-full px-4 py-1.5 text-xs font-medium transition-all ${invert
          ...
          <button
            ...
            className={`rounded-full px-4 py-1.5 text-xs font-medium transition-all ${animated
              ? "bg-neutral-900 text-white dark:bg-white dark:text-black"
              : "bg-neutral-200 text-neutral-700 hover:bg-neutral-300 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-700"
              }`}
          >
          ...
          <button
            ...
            className="rounded-full bg-blue-500 px-4 py-1.5 text-xs font-medium text-white transition-all hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700"
          >
