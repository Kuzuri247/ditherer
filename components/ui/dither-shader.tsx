...
export const DitherShader: React.FC<DitherShaderProps> = ({
  ...
  useEffect(() => {
    ...
    const processImage = (img: HTMLImageElement) => {
      ...
      const iw = img.naturalWidth || dimensions.width || 800;
      const ih = img.naturalHeight || dimensions.height || 600;
      ...
      if (animated) {
        const animate = () => {
          ...
          applyDithering(ctx, iw, ih, timeRef.current);
